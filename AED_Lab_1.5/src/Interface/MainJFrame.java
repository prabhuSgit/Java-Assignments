...
public class MainJFrame extends javax.swing.JFrame {
    ...
    public MainJFrame() {
        ...
        person.setLastName("Subramanian");
        person.setDob("1993/09/09");
        ...
        address1.setAddressLine1("106 Google Office");
        address1.setAddressLine2("California");
        address1.setCity("California");
        address1.setState("CA");
        address1.setCountry("MA");
        address1.setZipcode("002135");
        person.setWorkAddress(address1);
               
        address2.setAddressLine1("360 Huntingtone Ave");
        address2.setAddressLine2("Boston");
        address2.setCity("Boston");
        address2.setCountry("MA");
        address2.setState("CA");
        address2.setZipcode("002135");
        person.setLocalAddress(address2);
        
        address3.setAddressLine1("India");
        address3.setAddressLine2("India");
        address3.setCity("India");
        address3.setCountry("India");
        address3.setState("CA");
        address3.setZipcode("India");
        person.setHomeAddress(address3);
    ...
    private void initComponents() {
        ...
        jScrollPane1.setPreferredSize(new java.awt.Dimension(984, 476));
