...
public class CreateMedicalRecordJPanel extends javax.swing.JPanel {
    ...
    private void CreateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CreateBtnActionPerformed
        // TODO add your handling code here:
        person.getMedicalRecord().setMedicalRecordNbr(mrnNbrTextField.getText());
        person.getMedicalRecord().setAlergy1(alergy1TextField.getText());
        person.getMedicalRecord().setAlergy2(alergy2TextField.getText());
        person.getMedicalRecord().setAlergy3(alergy3TextField.getText());
        /*
        ...
        */
        JOptionPane.showMessageDialog(null, "Information submitted successfully!" + " " + "Thank you for submitting your details. Feel free to view your Report.");
