...
public class CreateProductJPanel extends javax.swing.JPanel {
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if(txtProdName.getText().isEmpty() || txtAvailablity.getText().isEmpty() || txtPrice.getText().isEmpty()||txtDescription.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Please add all the details!");
        }else{
            try{
            Double.parseDouble(txtPrice.getText());
            }catch(Exception e){
                JOptionPane.showMessageDialog(null, "Only numbers are allowed in Price field");
                return;
            }
            try{
